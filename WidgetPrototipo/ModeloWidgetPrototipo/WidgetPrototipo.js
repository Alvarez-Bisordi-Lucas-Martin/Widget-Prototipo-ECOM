$(function() {
    ...
    cargarJS('../ModeloWidgetScript/Urls.js', function() {
        ...
        function guardarMensajes(contenido, tipo, fecha) {
            var mensajes = JSON.parse(localStorage.getItem('chatMensajes')) || [];
            mensajes.push({ contenido: contenido, tipo: tipo, fecha: fecha });
        ...
        function cargarMensajes() {
            ...
            mensajes.forEach(function(mensaje) {
                generarMensaje(mensaje.contenido, mensaje.tipo, mensaje.fecha);
            });
        }
